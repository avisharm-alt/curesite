...
import { Award, Eye, Download, Trash2, Plus, Edit3, Save, X, CheckCircle, XCircle, DollarSign, Briefcase, MapPin, Building2, ExternalLink, GraduationCap, FileText, Clock, User } from 'lucide-react';
...
const AdminPanelPage = () => {
  ...
  const [fellowshipApplications, setFellowshipApplications] = useState([]);
